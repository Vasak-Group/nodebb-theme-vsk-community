...
<li component="sidebar/search" class="visible-open nav-item mx-2 search">
	<div class="d-flex gap-2 py-1 px-2 align-items-center" title="[[vsk-community:login-register-to-search]]">
		<i class="fa fa-fw fa-search text-muted"></i>
		<span class="nav-text visible-open text-xs text-muted">[[vsk-community:login-register-to-search]]</span>
	</a>
</a>
{{{ end }}}
