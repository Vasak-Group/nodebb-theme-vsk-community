...
theme.init = function (params, callback) {
	...
	routeHelpers.setupAdminPageRoute(params.router, '/admin/plugins/vsk-community', function (req, res, next) {
		res.render('admin/plugins/vsk-community', {});
	});
...
theme.getConfig = async function (config) {
	const settings = await meta.settings.get('vsk-community');
